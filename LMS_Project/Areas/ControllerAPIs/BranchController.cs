...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class BranchController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<HttpResponseMessage> Insert(BranchCreate model)
        {
        ...
        [HttpPut]
        [Route("")]
        public async Task<HttpResponseMessage> Update(BranchUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] BranchSearch baseSearch)
        {
