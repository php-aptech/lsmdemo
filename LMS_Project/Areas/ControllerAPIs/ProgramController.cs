...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class ProgramController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<HttpResponseMessage> Insert(ProgramCreate model)
        {
        ...
        [HttpPut]
        [Route("")]
        public async Task<HttpResponseMessage> Update(ProgramUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] ProgramSearch baseSearch)
        {
        ...
        public async Task<HttpResponseMessage> GetTeacherInProgram([FromUri] TeacherInProgramSearch baseSearch)
        {
        ...
        public async Task<HttpResponseMessage> AllowTeacher(int teacherId, int programId)
        {
            if (ModelState.IsValid)
            {
                try
