...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class CustomerNoteController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<HttpResponseMessage> Insert(CustomerNoteCreate model)
        {
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] CustomerNoteSearch baseSearch)
        {
