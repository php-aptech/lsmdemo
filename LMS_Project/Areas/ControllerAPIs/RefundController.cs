...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class RefundController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<HttpResponseMessage> Insert(RefundCreate model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    return Request.CreateResponse(HttpStatusCode.OK, new { message = "Bạn đã tạo yêu cầu hoàn tiền thành công, vui lòng đợi duyệt !", data });
                }
                catch (Exception e)
                {
        ...
        [HttpPut]
        [Route("")]
        public async Task<HttpResponseMessage> Update(RefundUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] RefundSearch baseSearch)
        {
