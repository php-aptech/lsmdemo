...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class SalaryConfigController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> InsertOrUpdate(SalaryConfigCreate model)
        {
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] SalaryConfigSearch baseSearch)
        {
