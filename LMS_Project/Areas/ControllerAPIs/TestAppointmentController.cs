...
{
    [RoutePrefix("api/TestAppointment")]
    [ClaimsAuthorize]
    public class TestAppointmentController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<HttpResponseMessage> Insert(TestAppointmentCreate model)
        {
        ...
        [HttpPut]
        [Route("")]
        public async Task<HttpResponseMessage> Update(TestAppointmentUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("")]
        public async Task<HttpResponseMessage> GetAll([FromUri] TestAppointmentSearch baseSearch)
        {
