...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class VideoCourseStudentController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> ActiveVideoCourse(ActiveVideoCourseModel itemModel)
        {
            try
            {
        ...
        public async Task<HttpResponseMessage> Insert(VideoCourseStudentCreate itemModel)
        {
            try
            {
